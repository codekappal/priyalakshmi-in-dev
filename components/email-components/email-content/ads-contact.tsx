// components/email-templates/ads-contact.tsx
import React from "react";

interface AdsContactEmailProps {
  name: string;
  company?: string;
  email: string;
  phone?: string;
...
export const AdsContactEmailTemplate: React.FC<AdsContactEmailProps> = ({
  name,
  company,
  email,
  phone,
  ...
  <div className="font-sans max-w-2xl mx-auto p-6 bg-white">
    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <p className="text-sm font-medium text-gray-500">Ad Budget</p>
          <p className="text-gray-800">{adBudget}</p>
        </div>
        <div>
          <p className="text-sm font-medium text-gray-500">Campaign Goal</p>
          <p className="text-gray-800">{campaignGoal}</p>
        </div>
      </div>
    </div>
